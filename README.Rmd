...
For most projects, restrict the Google Doc to your collaborators and commit `_publish.yml`.
This lets everyone working in Git publish to the same document and keeps other Quarto records together.
If you use **Anyone with the link**, commit the file only when everyone who can read the repository may also open the document.
GitHub secrets only work in GitHub Actions, not in local R sessions.
